...
import PersekutuanOrganizationalChart from '@/components/organizational-chart/persekutuan'
                ...
                <div className="bg-white rounded-2xl p-8 md:p-12 shadow-sm mb-16">
                  <div className="text-center max-w-3xl mx-auto">
                    <h2 className="text-3xl md:text-4xl font-semibold text-slate-800 tracking-tight">
                      Struktur Organisasi Bidang Persekutuan
                    </h2>
                  ...
                  <PersekutuanOrganizationalChart />
                </div>
              </div>

              {/* Artikel Section for Bidang Persekutuan */}
              <ArtikelBidang bidangName="Persekutuan" />
            </div>
          </div>
        </div>
      </div>
