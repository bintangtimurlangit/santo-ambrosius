...
export default function PortaSanctaPage() {
  // Redirect to home page - Porta Sancta is currently disabled
  redirect('/')

  // Original code commented out below - uncomment to restore the page
  // To restore: uncomment the imports above, remove the redirect, and uncomment the code below
  /*
  return (
