        ...
        <div className="py-16 md:py-20 lg:py-24">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="space-y-16">
              ...
              {/* Pastor 2 - Rm. Albertus Hendaryono */}
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  {/* Pastor Photo */}
                  <div className="lg:col-span-1">
                  ...
                  <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="space-y-4">
                      <div className="border-b border-gray-100 pb-3">
                        ...
                        <p className="text-slate-600">Gunung Kidul, 16 November 1955</p>
                      </div>

                      <div className="border-b border-gray-100 pb-3">
                        <h3 className="text-lg font-medium text-slate-800 mb-2">Tahbisan Imam</h3>
                        <p className="text-slate-600">Kentungan, 25 Januari 1984</p>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-3 text-slate-600 leading-relaxed">
                        <p>
                          <strong>1984 - 1986:</strong> Pastor Rekan di Paroki Kumetiran - Gereja
                          Hati Santa Perawan Maria Tak Bercela, Yogyakarta
                        </p>
                        <p>
                          <strong>1986 - 1989:</strong> Pastor Rekan di Paroki Medari - Gereja Santo
                          Yoseph, Yogyakarta dan Paroki Somohitan, Gereja Santo Yohanes Rasul,
                          Yogyakarta
                        </p>
                        <p>
                          <strong>1989 - 1992:</strong> Pastor Kepala di Paroki Kumetiran - Gereja
                          Hati Santa Perawan Maria Tak Bercela, Yogyakarta
                        </p>
                        <p>
                          <strong>1992 - 2011:</strong> Pastor TNI di Markas Besar TNI-AL
                        </p>
                        <p>
                          <strong>2011 - 2018:</strong> Pastor Kepala di Paroki Pulomas - Gereja
                          Santo Bonaventura, Jakarta Timur
                        </p>
                        <p>
                          <strong>2018 - 2022:</strong> Pastor Kepala di Paroki Kelapa Gading -
                          Gereja Santo Yakobus, Jakarta Utara
                        </p>
                        <p>
                          <strong>2022 - sekarang:</strong> Pastor Rekan di Paroki Villa Melati Mas
                          - Gereja Santo Ambrosius, Tangerang Selatan
                        </p>
                      </div>
                    </div>
                  </div>
